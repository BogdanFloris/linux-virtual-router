...
typedef enum {
    CONFIG_KEY_UNKNOWN,                  
    CONFIG_KEY_ENABLE_IPV4_FORWARDING,  
    CONFIG_KEY_NAT_OUTGOING_INTERFACE, 
    CONFIG_KEY_NAMESPACE,             
    CONFIG_KEY_BRIDGE,               
    CONFIG_KEY_FIREWALL_FORWARD_DEFAULT, 
    CONFIG_KEY_FIREWALL_ALLOW_FORWARD,  
    CONFIG_KEY_ENABLE_NAT              
} config_key_t;
